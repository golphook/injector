...
build-prod:
	$(move_to_temp) v $(cc) -prod -autofree -o $(bin_folder)\$(project_name) $(temp_project_path) $(move_back)
build-debug:
	$(move_to_temp) v $(cc) -g -autofree -o $(bin_folder)\$(project_name)-debug.exe $(temp_project_path) $(move_back)
debug-c:
	$(move_to_temp) v $(cc) -autofree -o $(bin_folder)\$(project_name)-debug.c $(temp_project_path)  $(move_back)
debug-cp:
